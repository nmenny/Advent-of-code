...
function isNiceStrV1(str) {
    ...
    isNice &= forbiddenStr.every((forbidden) => { return str.indexOf(forbidden) == -1 })
    ...
    for(var carIdx = 0; carIdx < str.length && !isNice; carIdx++) {

        if(vowels.indexOf(str[carIdx]) != -1)
            nbVowels++;
